...
def create_synchronized_missing_value_plot(df, output_dir):
    ...
    try:
        ...
        # Filter out EastAsiaLithiumCarbonateBatteryGrade and only keep columns that exist in df
        price_cols = [col for col in ticker_mapping.keys() if col in df.columns]
