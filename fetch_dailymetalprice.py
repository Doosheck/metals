...
def fetch_metal_prices_firefox(date: str):
    ...
    try:
        ...
        table = soup.find(
            "table",
            {"class": "table table-striped table-hover table-condensed success"},
        )
        metal_prices = {}
...
def get_metal_prices(
    from_date: str, to_date: str, metals: list, save_csv: bool = False
):
    """
