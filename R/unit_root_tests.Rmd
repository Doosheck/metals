...
dir.create("outputs/unit_root_tables", showWarnings = FALSE, recursive = TRUE)

# Generate and save table as PNG
lithium_table <- kable(lithium_summary_table, 
...
# Save as PNG
save_kable(lithium_table, here::here("outputs", "unit_root_tables", "lithium_unit_root_summary.png"), zoom = 2)
cat("Saved: outputs/unit_root_tables/lithium_unit_root_summary.png\n\n")
...
# Generate and save table as PNG
nickel_table <- kable(nickel_summary_table,
...
# Save as PNG
save_kable(nickel_table, here::here("outputs", "unit_root_tables", "nickel_unit_root_summary.png"), zoom = 2)
cat("Saved: outputs/unit_root_tables/nickel_unit_root_summary.png\n\n")
...
# Generate and save table as PNG
cobalt_table <- kable(cobalt_summary_table,
...
# Save as PNG
save_kable(cobalt_table, here::here("outputs", "unit_root_tables", "cobalt_unit_root_summary.png"), zoom = 2)
cat("Saved: outputs/unit_root_tables/cobalt_unit_root_summary.png\n\n")
...
# Generate and save table as PNG
copper_table <- kable(copper_summary_table,
...
# Save as PNG
save_kable(copper_table, here::here("outputs", "unit_root_tables", "copper_unit_root_summary.png"), zoom = 2)
cat("Saved: outputs/unit_root_tables/copper_unit_root_summary.png\n\n")
